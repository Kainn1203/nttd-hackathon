...
//         {/* <div className="absolute top-20 left-20 w-0 h-0 border-l-[100px] border-r-[100px] border-b-[150px] border-l-transparent border-r-transparent border-b-cyan-300/25 transform rotate-45 blur-sm"></div>
//         <div className="absolute bottom-40 right-40 w-0 h-0 border-l-[80px] border-r-[80px] border-b-[120px] border-l-transparent border-r-transparent border-b-purple-300/30 transform -rotate-30 blur-md"></div>
//         <div className="absolute top-1/2 left-1/4 w-0 h-0 border-l-[60px] border-r-[60px] border-b-[90px] border-l-transparent border-r-transparent border-b-white/20 transform rotate-60 blur-sm"></div> */}
...
//         <div className="absolute bottom-40 right-40 w-0 h-0
//           border-l-[400px] border-r-[400px] border-b-[600px]
//           border-l-transparent border-r-transparent border-b-purple-300/60
//           transform -rotate-30 blur-[1px] border border-purple-400/50"></div>
//         <div className="absolute top-1/2 left-1/4 w-0 h-0
//           border-l-[300px] border-r-[300px] border-b-[450px]
//           border-l-transparent border-r-transparent border-b-white/40
//           transform rotate-60 blur-[1px] border border-white/50"></div>
...
//           <h1 className="text-7xl font-medi text-white/90 mb-10 tracking-wide drop-shadow-lg">
//             社畜度診断テスト
//           </h1>
//           <p className="text-2xl font-normal text-white/95 max-w-3xl mx-auto leading-relaxed font-normal drop-shadow-lg">
//             {userName}さんの働き方はどのタイプでしょうか？<br/>
//             10個の質問で、あなたの働き方の特徴を分析します
//           </p>
//         </div>
//       </header>
...
//                   <div className="w-16 h-16 bg-gradient-to-br from-cyan-400/60 to-sky-500/50 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-white/30">
//                     <span className="text-white font-semibold text-sm drop-shadow">前回</span>
//                   </div>
//                 </div>

//                 {/* テキスト */}
//                 <div className="ml-6 flex-1">
//                   <h3 className="text-2xl font-semibold text-white/90 mb-3 drop-shadow-lg">前回の診断結果</h3>
//                   <div className="grid sm:grid-cols-3 gap-3 text-lg">
//                     <p className="text-white/80 drop-shadow-sm">
//                       <span className="font-medium text-white/90">タイプ：</span>{previousResult.diagnosis_result}
//                     </p>
//                     <p className="text-white/80 drop-shadow-sm">
//                       <span className="font-medium text-white/90">スコア：</span>{previousResult.scores}点
//                     </p>
//                     <p className="text-white/80 drop-shadow-sm">
//                       <span className="font-medium text-white/90">診断日：</span>{new Date(previousResult.created_at).toLocaleDateString('ja-JP')}
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//             診断を開始する
//           </button>
//           <p className="mt-6 text-lg font-semibold text-white/90 drop-shadow-sm">
//             診断には約3分かかります
//           </p>
//         </div>
...
function resolveTypeKey(prev: PreviousResultRaw | null): TypeKey {
  ...
  if (
    k &&
    ["type1", "type2", "type3", "type4", "type5"].includes(k as string)
  ) {
    return k as TypeKey;
  }
...
export default function DiagnosisStart({
  ...
  const [previousResult, setPreviousResult] =
    useState<PreviousResultRaw | null>(null);
  const [loading, setLoading] = useState(true);
    ...
    const fetchPreviousResult = async () => {
      try {
        const response = await fetch(
          `/api/corporate_diagnosis/history?userId=${userId}`
        );
        if (response.ok) {
          const data = await response.json();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cyan-300 via-sky-200 to-purple-300 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-60">
        ...
        {/* 三角／多角形・小物 */}
        <div className="absolute top-20 left-20 w-0 h-0 border-l-[150px] border-r-[150px] border-b-[225px] border-l-transparent border-r-transparent border-b-cyan-200/20 rotate-45 blur-md"></div>
        <div className="absolute top-20 left-20 w-0 h-0 border-l-[500px] border-r-[500px] border-b-[750px] border-l-transparent border-r-transparent border-b-sky-200/25 rotate-45 blur-xl"></div>
        <div className="absolute bottom-40 right-40 w-0 h-0 border-l-[400px] border-r-[400px] border-b-[600px] border-l-transparent border-r-transparent border-b-purple-200/25 -rotate-[30deg] blur-xl"></div>
        <div className="absolute top-1/2 left-1/4 w-0 h-0 border-l-[300px] border-r-[300px] border-b-[450px] border-l-transparent border-r-transparent border-b-pink-200/20 rotate-[60deg] blur-xl"></div>
        ...
        <div className="absolute top-3/4 right-1/6 w-16 h-16 bg-gradient-to-br from-white/25 to-sky-100/20 rotate-[30deg] blur-sm"></div>
        ...
        <div className="absolute top-3/4 right-1/6 w-[80px] h-[80px] bg-gradient-to-br from-white/50 to-sky-100/40 rotate-[30deg]"></div>
      ...
      {/* ヘッダー */}
      <header className="relative z-10 pt-8 sm:pt-12 md:pt-16 pb-6 sm:pb-8 md:pb-10">
        <div className="max-w-6xl mx-auto px-4 text-center">
          {/* タイトル */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)] mb-4 sm:mb-5 md:mb-6">
            社畜度診断テスト
          </h1>
          {/* 説明文 */}
          <p className="text-base sm:text-lg md:text-xl font-semibold text-white drop-shadow-[0_1px_4px_rgba(0,0,0,0.45)] leading-relaxed">
            {userName}さんの働き方はどのタイプだろうか？
      ...
      <main className="max-w-6xl mx-auto px-4 pb-8 sm:pb-10 md:pb-12 relative z-10">
        {/* 旧: max-w-5xl px-6 pb-20 */}
        {/* 過去の診断結果 */}
        {previousResult && (
          <div className="bg-gradient-to-br from-sky-300/60 via-purple-400/50 to-pink-500/60 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-lg border border-white/25 mb-6 sm:mb-8 hover:shadow-xl transition-all duration-300">
            {/* 旧: rounded-3xl mb-12 */}
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-stretch gap-3 sm:gap-4">
                ...
                <div className="flex-shrink-0 flex items-center justify-center">
                  <img
                    src={iconSrc}
                    alt={typeName}
                    className="h-16 sm:h-20 w-auto object-contain rounded-lg drop-shadow-[2px_2px_4px_rgba(0,0,0,0.45)]"
                  />
                  {/* 旧: h-23 rounded-xl 影弱め */}
                </div>

                {/* 右：見出し＋詳細 */}
                <div className="flex-1 text-center sm:text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-white/90 leading-tight drop-shadow-lg">
                    {/* 旧: text-2xl */}
                    前回の診断結果
                  </h3>
        ...
        <div className="bg-gradient-to-br from-sky-300/60 via-purple-400/50 to-pink-500/60 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-lg border border-white/25 mb-6 sm:mb-8 hover:shadow-xl transition-all duration-300">
          ...
          <div className="px-4 sm:px-6 py-6 sm:py-8">
            {/* 旧: px-10 py-12 */}
            <h2 className="text-xl sm:text-2xl font-normal text-white/90 mb-6 sm:mb-8 text-center drop-shadow-lg">
              {/* 旧: text-3xl mb-12 */}
              診断について
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              {/* 旧: gap-10 */}
              {/* 質問数 */}
              <div className="text-center p-3 sm:p-4 bg-gradient-to-r from-cyan-200/15 via-cyan-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-cyan-300/30 transition-all duration-300 hover:from-cyan-200/20 hover:via-cyan-100/15 hover:to-white/10">
                {/* 旧: p-6 rounded-2xl */}
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-cyan-500/55 to-sky-600/50 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 border border-white/30">
                  {/* 旧: w-24 h-24 mb-5 */}
                  <span className="text-xl sm:text-2xl font-light text-white drop-shadow">
                    {/* 旧: text-4xl */}
                    10
                  </span>
                </div>
                <h3 className="font-semibold text-white/90 mb-1 text-base sm:text-lg drop-shadow">
                  質問数
                </h3>
                {/* 旧: mb-2 text-xl */}
                <p className="text-white/75 text-xs sm:text-sm drop-shadow-sm px-2">
                  {/* 旧: text-lg */}
                  厳選された10問の質問に答えるだけ
                </p>
              </div>
              ...
              {/* 所要時間 */}
              <div className="text-center p-3 sm:p-4 bg-gradient-to-r from-sky-200/15 via-sky-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-sky-300/30 transition-all duration-300 hover:from-sky-200/20 hover:via-sky-100/15 hover:to-white/10">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-sky-500/55 to-blue-600/50 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 border border-white/30">
                  <span className="text-xl sm:text-2xl font-light text-white drop-shadow">
                    3
                  </span>
                </div>
              ...
              {/* 診断タイプ数 */}
              <div className="text-center p-3 sm:p-4 bg-gradient-to-r from-purple-200/15 via-purple-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-purple-300/30 transition-all duration-300 hover:from-purple-200/20 hover:via-purple-100/15 hover:to-white/10">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-500/55 to-violet-600/50 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 border border-white/30">
                  <span className="text-xl sm:text-2xl font-light text-white drop-shadow">
                    5
                  </span>
                </div>
        ...
        <div className="bg-gradient-to-br from-sky-300/60 via-purple-400/50 to-pink-500/60 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-lg border border-white/25 mb-6 sm:mb-8 hover:shadow-xl transition-all duration-300">
          ...
          <div className="px-4 sm:px-6 py-6 sm:py-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              {/* 旧: space-y-6 */}
              {/* タイプ1 */}
              <div className="flex flex-col sm:flex-row items-center p-4 sm:p-5 bg-gradient-to-r from-green-200/15 via-green-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-green-300/30 hover:from-green-200/20 hover:via-green-100/15 hover:to-white/10 transition-all duration-300 shadow-md hover:shadow-lg">
                ...
                <div className="sm:ml-6 flex-1 text-center sm:text-left">
                  <div className="sm:flex sm:items-center sm:justify-between">
                    <div>
                      <h3 className="font-semibold text-white/90 text-lg sm:text-xl drop-shadow-lg">
                        ゆるふわ KAIWAI
                      </h3>
                      <p className="text-xs sm:text-sm font-semibold text-white/70 mt-1 sm:mt-1.5 drop-shadow-sm">
              ...
              {/* タイプ2 */}
              <div className="flex flex-col sm:flex-row items-center p-4 sm:p-5 bg-gradient-to-r from-blue-200/15 via-blue-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-blue-300/30 hover:from-blue-200/20 hover:via-blue-100/15 hover:to-white/10 transition-all duration-300 shadow-md hover:shadow-lg">
                <div className="flex-shrink-0 mb-3 sm:mb-0">
                  <img
                    src="/images/score_v2_transparent.png"
                    alt="今日、定時に恋しました。"
              ...
              {/* タイプ3 */}
              <div className="flex flex-col sm:flex-row items-center p-4 sm:p-5 bg-gradient-to-r from-yellow-200/15 via-yellow-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-yellow-300/30 hover:from-yellow-200/20 hover:via-yellow-100/15 hover:to-white/10 transition-all duration-300 shadow-md hover:shadow-lg">
                <div className="flex-shrink-0 mb-3 sm:mb-0">
                  <img
                    src="/images/score_v3_transparent.png"
                    alt="タイパ重視"
              ...
              {/* タイプ4 */}
              <div className="flex flex-col sm:flex-row items-center p-4 sm:p-5 bg-gradient-to-r from-orange-200/15 via-orange-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-orange-300/30 hover:from-orange-200/20 hover:via-orange-100/15 hover:to-white/10 transition-all duration-300 shadow-md hover:shadow-lg">
                <div className="flex-shrink-0 mb-3 sm:mb-0">
                  <img
                    src="/images/score_v4_transparent.png"
                    alt="残業するのは、ダメですか？"
              ...
              {/* タイプ5 */}
              <div className="flex flex-col sm:flex-row items-center p-4 sm:p-5 bg-gradient-to-r from-red-200/15 via-red-100/10 to-white/5 backdrop-blur-sm rounded-xl border border-red-300/30 hover:from-red-200/20 hover:via-red-100/15 hover:to-white/10 transition-all duration-300 shadow-md hover:shadow-lg">
                <div className="flex-shrink-0 mb-3 sm:mb-0">
                  <img
                    src="/images/score_v5_transparent.png"
                    alt="残業が尊い...！"
                ...
                <div className="sm:ml-6 flex-1 text-center sm:text-left">
                  <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="mt-3 sm:mt-0 sm:text-right">
                      ...
                      <div className="w-full sm:w-28 bg-white/20 rounded-full h-2.5 border border-white/30 mx-auto sm:mx-0">
                        <div
                          className="bg-gradient-to-r from-red-300 to-red-400 h-2.5 rounded-full shadow-sm"
                          style={{ width: "100%" }}
                        ></div>
                      </div>
                    </div>
            ...
            <div className="mt-4 sm:mt-6 text-center">
              {/* 旧: mt-8 */}
              <p className="text-xs sm:text-sm font-semibold text-white/70 drop-shadow-sm">
                {/* 旧: text-lg */}
                スコアが高いほど社畜度が高くなります！
              </p>
            </div>
        ...
        <div className="text-center">
          <button
            onClick={handleStart}
            className="bg-gradient-to-r from-cyan-500/80 to-purple-600/80 backdrop-blur-2xl hover:from-cyan-400/90 hover:to-purple-500/90 border border-cyan-400/50 text-white font-medium text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
            {/* 旧: border-2 text-2xl px-16 py-6 rounded-2xl shadow-2xl */}
            診断を開始する
          </button>
          <p className="mt-2 sm:mt-3 text-xs sm:text-sm font-semibold text-white/90 mb-6 sm:mb-8 text-center drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]">
            {/* 旧: mt-6 text-lg */}
            診断には約3分かかるよ
          </p>
        </div>
